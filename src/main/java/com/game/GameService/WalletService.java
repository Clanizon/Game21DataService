...
public class WalletService {
	...
	public void createWallet( User newPlayer) {
	...
	/*public void updateReferralWallet(s , GameReferral newReferal) {
		Wallet walllet= walletRepository.findById(newReferal.getReferral());
		...
		if(walllet!=null && walllet.getWalletId()!=null){
			...
			walletAudit.setUpdatedTimeStamp(.getCreatedDate());		
	...
	public Object getWalletBy(String email) {
		// TODO Auto-generated method stub
		return walletRepository.findByUserId(email);
	}
	
	public Object updateWalletByUserId(String Id,Double Amount,String action) {
		// TODO Auto-generated method stub
		walletRepository.updateWalletByUser(Amount, Id);
